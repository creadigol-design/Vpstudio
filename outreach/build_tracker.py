...
rows = [
    [1, "Snowdonia Cheese Company", "Food — cheese", "Rhyl, Denbighshire", "North Wales ⭐",
     ...
     "YES – ready to send", "Scheduled 01-08-26", "Verified email – send-ready"],
    [2, "Wild Horse Brewing Co", "Drink — craft beer", "Llandudno, Conwy", "North Wales ⭐",
     ...
     "YES – ready to send", "Scheduled 01-08-26", "Verified email; warmest travel pitch – on the doorstep"],
    [3, "Different Dog", "Pet — fresh dog food", "Shrewsbury, Shropshire", "Welsh border",
     ...
     "YES – ready to send", "Scheduled 01-08-26", "Verified email; ~1 hr from DocShed"],
    [4, "Hilltop Honey", "Food — honey", "Newtown, Powys", "Mid Wales",
     ...
     "YES – ready to send", "Scheduled 01-08-26", "Verified email"],
    ...
    [6, "The Forest Distillery (Forest Gin)", "Drink — spirits", "Macclesfield, Cheshire", "North West",
     ...
     "YES – ready to send", "Scheduled 01-08-26", "Verified email; most visually stunning product on the list"],
    [7, "Adamo Foods", "Foodtech — mycelium steak", "London", "National",
     ...
     "YES – ready to send", "Scheduled 01-08-26", "Verified email; highest-contrast story"],
    ...
    [9, "ReBorn Homewares", "Homeware", "Wiltshire", "National",
     ...
     "YES – ready to send", "Scheduled 01-08-26", "Verified email; waste-to-product = ready-made video"],
    [10, "ACTIPH Water", "Drink — water", "London", "National",
     ...
     "YES – ready to send", "Scheduled 01-08-26", "Verified email (general inbox)"],
]
